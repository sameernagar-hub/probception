...
Codex generates hypotheses and candidate experiments. Selection (`design/eig.py`)
...
├── agents/llm.py      Codex wrapper (structured outputs, caching, tracing)
